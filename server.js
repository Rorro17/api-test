...
// on routes that end in /matches
// ----------------------------------------------------
router.route('/matches')
    // create a match (accessed at POST http://localhost:8080/api/match)
    .post(function(req, res) {
...
// on routes that end in /matches/:player_id
// ----------------------------------------------------
router.route('/matches/:player_id')
    ...
    .get(function(req, res) {
    	Match.find(function(err, matches) {
            if (err)
                res.send(err);
			if (match.player1 == req.params.player_id || match.player2 == req.params.player_id) {
	 			res.json(matches);
				}
            });
    })
